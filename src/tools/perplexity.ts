  ...
  server.tool(
    ...
    "Perform deep web research on a given topic",
    {
      query: z
        .string()
        .describe(
          "The research question or query - be specific and contextual for best results. Use this tool searching the web and getting general, comprehensive answers, using a combination of web results and scholarly sources. Do not use it for finding specific information."
        ),
